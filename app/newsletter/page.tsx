  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="text-center mb-12">
        ...
        <div className="bg-accent/10 p-6 rounded-xl shadow-md inline-flex items-center space-x-3 text-accent font-medium">
          <Rss className="w-6 h-6" />
          <span>Iscriviti per non perdere i nostri aggiornamenti!</span>
          <a
            href="#"
            className="ml-4 bg-accent text-white py-2 px-5 rounded-full hover:bg-accent/90 transition duration-300 shadow"
          >
            Iscriviti
          </a>
        </div>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articlesWithIcons.map((article) => (
            <Link href={`/newsletter/${createSlug(article.title)}`} key={article.title} className="block card rounded-xl shadow-lg hover:shadow-xl transition duration-300 overflow-hidden group">
      ...
      <div className="mt-20 text-center card rounded-xl shadow-lg p-8 md:p-12 border card-border">
        ...
        <a
          href="#"
          className="inline-block bg-accent text-white font-semibold py-3 px-8 rounded-full text-lg hover:bg-accent/90 transition duration-300 shadow-lg"
        >
          Proponi un Articolo
        </a>
      </div>
